...
export default class Cabinet extends Component {
  state = {
    ...
    activeBookings: [
      {
        id: 1,
        icon: '🎓',
        title: 'Аудитория 1-101',
        location: 'Корпус 1, 1 этаж · 30 мест · Проектор',
      ...
      },
      {
        id: 2,
        icon: '💻',
        title: 'Компьютерный класс 7-502',
        location: 'Корпус 7, 3 этаж · 25 мест · 20 ПК',
    ...
    historyBookings: [
      {
        ...
        icon: '🎓',
        title: 'Аудитория 4-3',
        location: 'Корпус 4, 1 этаж · Поточный зал',
      ...
      },
      {
        id: 5,
        icon: '💻',
        title: 'Компьютерный класс 7-701',
        location: 'Корпус 7, 7 этаж',
    ...
    notifications: [
      {
        id: 1,
        text: '<strong>Аудитория 6-118 освободилась</strong> — вы подписались на уведомление. Доступна с 13:45 до 18:00.',
        time: '10 мин назад',
        read: false,
      },
      {
        id: 2,
        text: '<strong>Напоминание:</strong> бронь 1-101 начинается через 1 час (в 12:00).',
        time: '1 час назад',
        read: false,
      },
      {
        id: 3,
        text: '<strong>Бронь 8-305 подтверждена</strong> на 27 марта, 14:00–16:00.',
        time: 'вчера',
        read: false,
      },
      {
        id: 4,
        text: 'Бронь 2-210 от 24 марта успешно завершена.',
        time: '24 мар',
        read: true,
      },
    ],
