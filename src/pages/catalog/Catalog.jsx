    ...
    rooms: [
      {
        id: 1,
        number: '1-101',
        name: 'Учебная аудитория · Корпус 1, 1 этаж',
        icon: '🎓',
        status: 'green',
      ...
      },
      {
        id: 2,
        number: '4-4',
        name: 'Поточный зал · Корпус 4, 1 этаж',
        icon: '📢',
        status: 'red',
        specs: ['250 мест', 'Микрофон', 'Проектор'],
      ...
      },
      {
        id: 3,
        number: '7-701',
        name: 'Компьютерный класс · Корпус 7, 7 этаж',
        icon: '💻',
        status: 'green',
      ...
      {
        id: 4,
        number: 'Конференц зал',
        name: 'Конференц зал · Корпус 1, 2 этаж',
        icon: '🤝',
        status: 'orange',
        specs: ['12 мест', 'Экран'],
      ...
      },
      {
        id: 5,
        number: '7-104',
        name: 'Учебная аудитория · Корпус 7, 1 этаж',
        icon: '🎓',
        status: 'green',
      ...
      },
      {
        id: 6,
        number: '4-234',
        name: 'Лаборатория · Корпус 4, 2 этаж',
        icon: '🔬',
        status: 'red',
